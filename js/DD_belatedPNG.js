...
var DD_belatedPNG = {
	...
	createVmlStyleSheet: function() { /* style VML, enable behaviors */
		/*
			...
			and hit_cnt the 31-limit mark, let's not use that method!
	...
	**/
	...
	vmlOffsets: function(el) {
		...
		if (bgR != 'repeat') {
			var c = {'T':(bg.Y), 'R':(bg.X+size.w), 'B':(bg.Y+size.h), 'L':(bg.X)}; /* these are defaults for no-repeat - clips down_cnt to the image location */
...
} catch(r) { (console.warn || console.log)(e); }
